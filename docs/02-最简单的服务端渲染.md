...
![Home 页面效果](./images/01-home-page.png)

+ home 页面源码

![Home 页面源代码](./images/02-home-page-source-code.png)
...
+ 但是我们还是要把事件注册到 DOM 元素上，所以我们就需要了解一个新的概念 **同构**
...
+ 为什么要同构？
  + 优点是提高代码的复用，减少代码的开发。
  + 缺点也很明显，就是需要在不同的平台上进行不同的构建，有一定的构建成本，另外对服务器有一定的负载。
...
![home 页面事件](./images/03-home-page-event.png)

+ home 页面事件源代码

![home 页面事件源代码](./images/04-home-page-event-source-code.png)

## 2.7 hydrate

+ 但是现在我们在控制台看到了一个警告信息

![hydrate](./images/05-hydrate.png)
