...
![首页面效果](./images/06-router-home-page.png)

+ 首页面源代码

![首页面源代码](./images/07-router-home-page-source-code.png)

+ news 页面效果

![news 页面效果](./images/08-router-news-page.png)

+ news 页面源代码

![news 页面源代码](./images/09-router-news-page-source-code.png)
